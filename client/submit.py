...
# Modify the `aname` and `files` below according to your assignment configuration.
aname = 'project4'
files = {
    'scheme.py': open('scheme.py', 'rb'),
    'scheme_reader.py': open('scheme_reader.py', 'rb'),
    'questions.scm': open('questions.scm', 'rb')
}
